...
```bash
cd exercices
# Créez votre fichier selon les instructions de l'exercice
...
```
✓ Exercice 1 : Gestionnaire de contacts (Classes)
✓ Exercice 2 : Tri avec lambda
✓ Exercice 3 : Liste chaînée avec smart pointers
✓ Exercice 4 : Gestion de fichiers RAII
