...
- [2.5 - Classes et Objets](02-bases/05-classes-objets.md)
- [2.6 - Héritage et Polymorphisme](02-bases/06-heritage-polymorphisme.md)
...
- [3.3 - Conteneurs STL](03-moderne/03-conteneurs.md)
- [3.4 - Gestion des Erreurs](03-moderne/04-exceptions-optional.md)
- [3.5 - Algorithmes STL](03-moderne/05-algorithmes-stl.md)
...
### 1. Approche linéaire (recommandée)
...
1. Lisez un chapitre
2. Étudiez les exemples dans [`/exemples`](../exemples/)
...
Passez aux exemples correspondant aux chapitres : [`/exemples`](../exemples/).
